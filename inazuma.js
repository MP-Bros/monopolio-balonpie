...
square[6] = new Square("Talisman", "$100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
...
square[10] = new Square("Descansando", "", "transparent");
...
square[28] = new Square("Equipamiento", "$150", "transparent", 150, 2);
